...
namespace CapaVista
{
    public partial class frmAgregarEmpleado : Form
    {
        ...
        public frmAgregarEmpleado()
        {
            ...
            navegador1.funLlenarComboControl(cmbTipoBodega, "TipoBodega", "pkid", "nombre", "estado");
        ...
        private void cmbTipoBodega_SelectedIndexChanged(object sender, EventArgs e)
        {
            navegador1.funComboTextboxVista(cmbTipoBodega, txtTipoBodega);
        }

        private void txtTipoBodega_TextChanged(object sender, EventArgs e)
        {
            navegador1.funTextboxComboVista(cmbTipoBodega, txtTipoBodega);
        }
    }
}
