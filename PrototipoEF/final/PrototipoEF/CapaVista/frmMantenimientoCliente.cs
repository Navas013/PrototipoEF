    ...
    public partial class frmDesarrolloDeCarrera : Form
    {
        ...
        public frmDesarrolloDeCarrera()
        {
           ...
           navegador1.idAplicacion = "5006";//en la nueva se usara el nombre
            ...
            navegador1.funLlenarComboControl(cmbTipoCliente, "tipocliente", "pkid", "nombre", "estado");
        ...
        private void cmbTipoCliente_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            navegador1.funTextboxComboVista(cmbTipoCliente, txtTipoCliente);
            navegador1.funComboTextboxVista(cmbTipoCliente, txtTipoCliente);
        }
